...
Astra Trident can create Cloud Volumes Service volumes in one of two link:https://docs.cloud.google.com/netapp/volumes/docs/discover/overview[service types^]:
